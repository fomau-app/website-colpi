      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              href="https://app.colpi.fr/colpiStore"
              target="_blank"
              rel="noopener noreferrer"
              className="shimmer-btn-gold text-white text-sm font-semibold px-5 py-2.5 rounded-full transition-all duration-200 hover:scale-105"
            >
              Télécharger l&apos;app
            </a>
          </div>
        ...
        {open && (
          ...
          >
            ...
            <motion.a
              ...
              className="shimmer-btn-gold text-white text-center font-semibold px-6 py-3.5 rounded-full mt-4"
              onClick={() => setOpen(false)}
            >
              Télécharger l&apos;app
            </motion.a>
